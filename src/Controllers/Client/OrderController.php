...
use Mx2\XuongOop\Models\Cart;
use Mx2\XuongOop\Models\CartDetail;
use Mx2\XuongOop\Models\Order;
use Mx2\XuongOop\Models\OrderDetail;
...
class OrderController extends Controller
{
    ...
    public function checkout()
    {
        ...
        // Xoá dữ liệu trong Cart + CartDetail theo CartID - $_SESSION['cart_id']
