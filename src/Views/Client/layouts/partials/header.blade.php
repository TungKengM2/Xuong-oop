        ...
        <div class="container">
            <div class="row small-gutters">
                <div class="col-xl-3 col-lg-3 d-lg-flex align-items-center">
                    <div id="logo">
                        <a href="{{url('')}}"><img src="{{asset('assets/img/phone.jpg')}}" alt="" width="100" height="35"></a>
                    </div>
                </div>
                    ...
                    <ul class="top_tools">
                        <li>
                            <div class="dropdown dropdown-cart">
                                <a href="{{ asset('cart/detail') }}" class="cart_bt"></a>
                                <div class="dropdown-menu">

                                    <div class="total_drop">
                                        <a href="{{ asset('cart/detail') }}" class="btn_1 outline">View Cart</a><a
                                            href="{{ asset('order/checkout') }}" class="btn_1">Checkout</a>
                                    </div>
                                </div>
                            </div>
                            <!-- /dropdown-cart-->
                            ...
                            <div class="dropdown dropdown-access">
                                ...
                                <div class="dropdown-menu">
                                    <ul>
                                        ...
                                        @if (isset($_SESSION['user']))
                                            <a class="btn btn-primary" href="{{ url('logout') }}"><i
                                                    class="ti-user"></i>LogOut</a>
                                        @endif
                                    </ul>
